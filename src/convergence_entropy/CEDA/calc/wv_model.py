...
class wv(nn.Module):
    ...
    def __init__(self, model='roberta-base', special_tokens=True, device='cpu', layers=[7,-1], max_sequence_length=500, clip_at=400, pre_sequence_stride=100):
        ...
        self.mod = AutoModel.from_pretrained(model, config=self.config).to(self.dev)
